...
This is the foundation of how serious AI-assisted development works: not relying on
the model's training data, but feeding it the actual source of truth.
...
Your job: use AI to produce a structured review of the entire RetroFlow codebase: the kind
of review a senior developer would do before a production deployment.
